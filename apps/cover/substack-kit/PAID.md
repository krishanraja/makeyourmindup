...
---
# Paid-tier copy, ready to paste

This is the one place CTRL may be named: CTRL beta access in the paid tier is
the only permitted connection between the channel and mind/make. The kill list
still runs every other rule on this file.
...
The paid email above, with this line added straight after the first paragraph:

You went founding member, which means you paid more than you had to. Thank you twice.

## Subscription benefits (Settings, Payments)
...
- Beta access to CTRL
- Diagrams and artifacts as files you can reuse
- The audio and video editions
- A monthly live session with Krish
