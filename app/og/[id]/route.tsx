...
function renderSigil(params: ReturnType<typeof compose>, width: number, height: number) {
  ...
  return (
    <svg width={width} height={height} viewBox={`0 0 ${VIEW} ${VIEW}`} xmlns="http://www.w3.org/2000/svg">
      {nodes}
    </svg>
  );
}
